...
export const translations: Translations = {
  fr: {
    ...
    'settings.textSize.reset': 'Réinitialiser la taille du texte',
    ...
    // Vault
    'vault.title.unlock': 'Déverrouiller le coffre-fort',
    'vault.title.create': 'Sécuriser vos clés API',
    'vault.subtitle.unlock': 'Entrez votre mot de passe maître pour accéder à vos clés et configurations chiffrées.',
    'vault.subtitle.create': 'Choisissez un mot de passe maître pour chiffrer localement toutes vos clés API et secrets.',
    'vault.password.label': 'Mot de passe maître',
    'vault.password.placeholder': 'Entrez votre mot de passe...',
    'vault.confirmPassword.label': 'Confirmer le mot de passe',
    'vault.confirmPassword.placeholder': 'Confirmez votre mot de passe...',
    'vault.btn.unlock': 'Déverrouiller',
    'vault.btn.create': 'Créer le coffre chiffré',
    'vault.btn.reset': 'Réinitialiser le coffre',
    'vault.btn.lock': 'Verrouiller le coffre',
    'vault.error.wrongPassword': 'Mot de passe incorrect.',
    'vault.error.mismatch': 'Les deux mots de passe ne correspondent pas.',
    'vault.error.tooShort': 'Le mot de passe doit contenir au moins 6 caractères.',
    'vault.reset.confirm': 'Êtes-vous sûr de vouloir réinitialiser le coffre-fort ?',
    'vault.reset.title': 'Réinitialisation du coffre-fort',
    'vault.reset.desc': 'Attention : cette action supprimera définitivement toutes les clés API et configurations chiffrées stockées localement.',
    'vault.reset.btnConfirm': 'Confirmer et tout effacer',
    'vault.reset.btnCancel': 'Annuler',
    'vault.import.pwdTitle': 'Fichier chiffré par un autre utilisateur',
    'vault.import.pwdDesc': 'Ce fichier a été chiffré avec un mot de passe différent. Entrez le mot de passe fourni par la personne qui a exporté cette configuration pour la déchiffrer :',
    'vault.import.pwdError': 'Mot de passe incorrect pour ce fichier.',
    'vault.import.fileLabel': 'Fichier à importer :',
    'vault.import.btnSubmit': 'Déchiffrer et importer',
    'vault.import.passwordPlaceholder': 'Mot de passe du fichier...',
    ...
    'accountCreation.supabase.pat.hint': 'Jeton personnel qui autorise le configurateur à piloter votre compte via l\'API Supabase — il donne accès à toutes vos organisations et à tous vos projets. Accès direct : supabase.com/dashboard/account/tokens. Affiché une seule fois : copiez-le immédiatement, préfixe sbp_ compris. Le régénérer révoque le précédent — si le configurateur répond « jeton refusé », c\'est en général qu\'une ancienne valeur a été recopiée.',

    // Supabase — projet piloté depuis le configurateur
    'accountCreation.supabase.projectMode': 'Projet Supabase',
    'accountCreation.supabase.projectMode.existing': 'Utiliser un projet existant',
    'accountCreation.supabase.projectMode.create': 'Créer le projet depuis le configurateur',
    'accountCreation.supabase.existingProject': 'Projet à utiliser',
    'accountCreation.supabase.existingProject.placeholder': '— Choisir un projet —',
    'accountCreation.supabase.projects.error': 'Impossible de charger les projets.',
    'accountCreation.supabase.verify': 'Vérifier le projet',
    'accountCreation.supabase.verify.ok': 'Projet confirmé — le configurateur communique bien avec lui.',
    'accountCreation.supabase.verify.partial': "Projet trouvé, mais il n'est pas complètement prêt.",
    'accountCreation.supabase.verify.error': 'Vérification impossible.',
    'accountCreation.supabase.verify.failed': "Projet introuvable — la référence enregistrée ne correspond à aucun projet de ce compte.",
    'accountCreation.supabase.verify.name': 'Nom :',
    'accountCreation.supabase.verify.ref': 'Référence :',
    'accountCreation.supabase.verify.region': 'Région :',
    'accountCreation.supabase.verify.status': 'Statut :',
    'accountCreation.supabase.verify.services': 'Services :',
    'accountCreation.supabase.verify.running': 'Détection du projet…',
    'accountCreation.supabase.projects.loading': '— Chargement des projets… —',
    'accountCreation.supabase.orgs.loading': '— Chargement des organisations… —',
    'accountCreation.supabase.nameTaken': 'Un projet nommé « {name} » existe déjà sur ce compte. Changez le nom ci-dessus pour en créer un autre, ou servez-vous de celui-ci :',
    'accountCreation.supabase.nameTaken.switch': 'Utiliser ce projet',
    'accountCreation.supabase.created': 'Projet créé — le configurateur l\'a provisionné sur votre compte.',
    'accountCreation.supabase.created.next': "Les clés API, les URLs Postgres et les buckets de stockage seront récupérés à l'étape 2.",
    'accountCreation.supabase.projects.none': "Aucun projet sur ce compte. Basculez sur « Créer le projet depuis le configurateur », ou créez-en un depuis le dashboard Supabase.",
    'accountCreation.supabase.dbPassword.generate': 'Générer',
    'accountCreation.supabase.dbPassword.requirements': 'Exigences du mot de passe',
    'accountCreation.supabase.dbPassword.rule.minLength': 'Au moins 12 caractères',
    'accountCreation.supabase.dbPassword.rule.asciiOnly': 'Lettres, chiffres et ponctuation ASCII uniquement — ni espace, ni accent, ni emoji',
    ...
    'accountCreation.supabase.organization.placeholder': '— Choisir une organisation —',
    'accountCreation.supabase.organization.refresh': 'Charger',
    'accountCreation.supabase.organization.needToken': "Renseignez le jeton d'accès ci-dessus pour charger la liste.",
    'accountCreation.supabase.organization.hint': "Organisation dans laquelle le projet est créé et facturé. Le plan Free est limité à deux projets actifs par organisation.",
    'accountCreation.supabase.orgs.error': 'Impossible de charger les organisations.',
    'accountCreation.supabase.region': 'Région',
    'accountCreation.supabase.region.hint': "Région d'hébergement de la base. Choisissez la plus proche de vos participants : eu-west-3 correspond à Paris.",
    'accountCreation.supabase.alreadyCreated': 'Projet déjà créé :',
    'accountCreation.supabase.creating': 'Création du projet en cours…',
    'accountCreation.supabase.createBtn': 'Créer le projet maintenant',
    'accountCreation.supabase.createBtn.retry': 'Réessayer la création',
    'accountCreation.supabase.createBtn.missing': "Renseignez le jeton d'accès, l'organisation et le mot de passe de la base pour lancer la création.",
    'field.optional': '(facultatif)',
    'accountCreation.supabase.dbPassword': 'Mot de passe de la base de données',
    'accountCreation.supabase.dbPassword.placeholder': 'Mot de passe fort',
    'accountCreation.supabase.dbPassword.path': 'Choisi à la création du projet Supabase',
    'accountCreation.supabase.dbPassword.hint': "La seule valeur que l'API Supabase ne restitue jamais. C'est elle qui permet à l'étape 2 de construire DATABASE_URL et DIRECT_URL sans copier-coller. Évitez $, `, \" et ' : le mot de passe finit dans un fichier .env lu par des scripts shell. Les caractères d'URL (@, :, /, ?, #) sont encodés automatiquement.",
    ...
    'apiConfig.supabase.buckets.title': 'Créer les buckets de stockage',
    'apiConfig.supabase.buckets.desc': "Storage > New bucket. L'application lit et écrit dans cinq buckets distincts — créez-les tous, avec exactement ces noms.",
    'apiConfig.supabase.buckets.public': 'Public bucket',
    'apiConfig.supabase.buckets.private': 'privé',
    'apiConfig.supabase.buckets.btn': 'Ouvrir Storage',
    'apiConfig.supabase.pwFill.label': 'Remplacer [YOUR-PASSWORD] par le mot de passe de la base de données',
    'apiConfig.supabase.pwFill.placeholder': 'Mot de passe choisi à la création du projet',
    ...
    'step8.adminLogin.btn': 'Connexion admin — unheard.cfd',
  ...
  en: {
    ...
    'settings.textSize.reset': 'Reset text size',
    ...
    // Vault
    'vault.title.unlock': 'Unlock Vault',
    'vault.title.create': 'Secure Your API Keys',
    'vault.subtitle.unlock': 'Enter your master password to access your encrypted API keys and configuration.',
    'vault.subtitle.create': 'Choose a master password to encrypt all your API keys and secrets locally.',
    'vault.password.label': 'Master Password',
    'vault.password.placeholder': 'Enter your password...',
    'vault.confirmPassword.label': 'Confirm Password',
    'vault.confirmPassword.placeholder': 'Confirm your password...',
    'vault.btn.unlock': 'Unlock',
    'vault.btn.create': 'Create Encrypted Vault',
    'vault.btn.reset': 'Reset Vault',
    'vault.btn.lock': 'Lock Vault',
    'vault.error.wrongPassword': 'Incorrect password.',
    'vault.error.mismatch': 'Passwords do not match.',
    'vault.error.tooShort': 'Password must be at least 6 characters long.',
    'vault.reset.confirm': 'Are you sure you want to reset the vault?',
    'vault.reset.title': 'Reset Encrypted Vault',
    'vault.reset.desc': 'Warning: this will permanently delete all encrypted API keys and local configurations.',
    'vault.reset.btnConfirm': 'Confirm and erase everything',
    'vault.reset.btnCancel': 'Cancel',
    'vault.import.pwdTitle': 'File Encrypted by Another User',
    'vault.import.pwdDesc': 'This file was encrypted with a different password. Please enter the password provided by the person who exported this configuration to decrypt it:',
    'vault.import.pwdError': 'Incorrect password for this file.',
    'vault.import.fileLabel': 'File to import:',
    'vault.import.btnSubmit': 'Decrypt and Import',
    'vault.import.passwordPlaceholder': 'File password...',
    ...
    'accountCreation.supabase.pat.hint': 'Personal token that lets the configurator drive your account through the Supabase API — it grants access to every organization and every project. Direct link: supabase.com/dashboard/account/tokens. Shown only once: copy it immediately, sbp_ prefix included. Regenerating it revokes the previous one — if the configurator answers \'token refused\', an old value has usually been pasted back.',

    // Supabase — project driven from the configurator
    'accountCreation.supabase.projectMode': 'Supabase project',
    'accountCreation.supabase.projectMode.existing': 'Use an existing project',
    'accountCreation.supabase.projectMode.create': 'Create the project from the configurator',
    'accountCreation.supabase.existingProject': 'Project to use',
    'accountCreation.supabase.existingProject.placeholder': '— Pick a project —',
    'accountCreation.supabase.projects.error': 'Could not load the projects.',
    'accountCreation.supabase.verify': 'Verify the project',
    'accountCreation.supabase.verify.ok': 'Project confirmed — the configurator reaches it.',
    'accountCreation.supabase.verify.partial': 'Project found, but it is not fully ready.',
    'accountCreation.supabase.verify.error': 'Verification failed.',
    'accountCreation.supabase.verify.failed': 'Project not found — the stored reference matches no project on this account.',
    'accountCreation.supabase.verify.name': 'Name:',
    'accountCreation.supabase.verify.ref': 'Reference:',
    'accountCreation.supabase.verify.region': 'Region:',
    'accountCreation.supabase.verify.status': 'Status:',
    'accountCreation.supabase.verify.services': 'Services:',
    'accountCreation.supabase.verify.running': 'Detecting the project…',
    'accountCreation.supabase.projects.loading': '— Loading projects… —',
    'accountCreation.supabase.orgs.loading': '— Loading organizations… —',
    'accountCreation.supabase.nameTaken': 'A project named "{name}" already exists on this account. Change the name above to create another one, or work with this one:',
    'accountCreation.supabase.nameTaken.switch': 'Use this project',
    'accountCreation.supabase.created': 'Project created — the configurator provisioned it on your account.',
    'accountCreation.supabase.created.next': 'The API keys, Postgres URLs and storage buckets are retrieved at step 2.',
    'accountCreation.supabase.projects.none': 'No project on this account. Switch to "Create the project from the configurator", or create one from the Supabase dashboard.',
    'accountCreation.supabase.dbPassword.generate': 'Generate',
    'accountCreation.supabase.dbPassword.requirements': 'Password requirements',
    'accountCreation.supabase.dbPassword.rule.minLength': 'At least 12 characters',
    'accountCreation.supabase.dbPassword.rule.asciiOnly': 'ASCII letters, digits and punctuation only — no space, accent or emoji',
    ...
    'accountCreation.supabase.organization.placeholder': '— Pick an organization —',
    'accountCreation.supabase.organization.refresh': 'Load',
    'accountCreation.supabase.organization.needToken': 'Fill in the access token above to load the list.',
    'accountCreation.supabase.organization.hint': 'The organization the project is created in and billed to. The Free plan allows two active projects per organization.',
    'accountCreation.supabase.orgs.error': 'Could not load the organizations.',
    'accountCreation.supabase.region': 'Region',
    'accountCreation.supabase.region.hint': 'Where the database is hosted. Pick the one closest to your participants: eu-west-3 is Paris.',
    'accountCreation.supabase.alreadyCreated': 'Project already created:',
    'accountCreation.supabase.creating': 'Creating the project…',
    'accountCreation.supabase.createBtn': 'Create the project now',
    'accountCreation.supabase.createBtn.retry': 'Try creating again',
    'accountCreation.supabase.createBtn.missing': 'Fill in the access token, the organization and the database password to start.',
    'field.optional': '(optional)',
    'accountCreation.supabase.dbPassword': 'Database password',
    'accountCreation.supabase.dbPassword.placeholder': 'A strong password',
    'accountCreation.supabase.dbPassword.path': 'Chosen when the Supabase project is created',
    'accountCreation.supabase.dbPassword.hint': 'The one value the Supabase API never hands back. It is what lets step 2 build DATABASE_URL and DIRECT_URL without any copy-paste. Avoid $, `, \" and \': the password ends up in a .env file read by shell scripts. URL characters (@, :, /, ?, #) are encoded for you.',
    ...
    'apiConfig.supabase.buckets.title': 'Create the storage buckets',
    'apiConfig.supabase.buckets.desc': 'Storage > New bucket. The app reads and writes five separate buckets — create them all, exactly with these names.',
    'apiConfig.supabase.buckets.public': 'Public bucket',
    'apiConfig.supabase.buckets.private': 'private',
    'apiConfig.supabase.buckets.btn': 'Open Storage',
    'apiConfig.supabase.pwFill.label': 'Replace [YOUR-PASSWORD] with your database password',
    'apiConfig.supabase.pwFill.placeholder': 'Password chosen when the project was created',
    ...
    'step8.adminLogin.btn': 'Admin login — unheard.cfd',
