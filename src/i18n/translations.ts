...
export const translations: Translations = {
  fr: {
    ...
    'accountCreation.supabase.createBtn.locked': "Un projet portant ce nom existe déjà sur ce compte. Changez le nom ci-dessus pour en créer un autre, ou basculez sur « Utiliser un projet existant » pour vous servir de celui-ci.",
  ...
  en: {
    ...
    'accountCreation.supabase.createBtn.locked': 'A project with this name already exists on this account. Change the name above to create another one, or switch to "Use an existing project" to work with it.',
