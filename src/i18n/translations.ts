...
export const translations: Translations = {
  fr: {
    ...
    'accountCreation.supabase.createBtn.locked': "Ce projet existe déjà. Changez le nom ci-dessus pour en créer un autre.",
  ...
  en: {
    ...
    'accountCreation.supabase.createBtn.locked': 'This project already exists. Change the name above to create another one.',
